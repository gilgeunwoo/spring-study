...
import com.example.spring2.service.CustomMemberDetailsService;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = customMemberDetailsService.loadUserByUsername(getUsername(token).getSubject());
